        ...
        <div class="row">
          ...
          <div class="col-lg-5 ml-auto">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">D.D. Nagar, Gwalior, M.P., India</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a style="text-decoration: none;" href="#">+91-9516623750</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a style="text-decoration: none;" href="#">vivek3101pandit@gmail.com</a></p>
